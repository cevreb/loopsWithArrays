...
Writing good unit tests will ensure that your program is running correctly at all stages of development. This will save the developer time and effort that is required to fix any bugs that may pop up. 
